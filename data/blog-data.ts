...
export const BLOG_POSTS: BlogPost[] = [
  ...
  {
    id: 9,
    title: "blog_post_9_title",
    slug: "which-platform-wins-for-moroccan-smbs-wordpress-vs-shopify-conversion-breakdown",
    date: "blog_post_9_date",
    sortDate: "2026-05-26",
    category: "Development",
    image: "/assets/img/bg-img/46.webp",
    excerpt: "blog_post_9_excerpt",
    content: [
      "blog_post_9_p_1",
      "blog_post_9_p_2",
      "blog_post_9_p_3",
    ...
    quote: {
      text: "blog_post_9_quote",
    },
    tags: ["ecommerce", "morocco", "wordpress", "shopify", "woocommerce", "small-business"],
    author: "Dev Agency",
    readingTimeMinutes: 14,
    serviceAlignment: "ecommerce",
  },
]
