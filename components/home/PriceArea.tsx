            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="price-card">
                <div className="price-info">
                  ...
                  <p className="mb-0">
                    We prioritize their success because is drive authentic
                    relationships.
                  </p>
                </div>
                ...
                <ul className="price-description list-unstyled">
                  ...
                  <li>
                    <span className="material-symbols-outlined">check</span> UI
                    Design Create
                  </li>
                  <li>
                  ...
                  <li>
                    <span className="material-symbols-outlined">check</span> One
                    Year Support Included
                  </li>
                </ul>
