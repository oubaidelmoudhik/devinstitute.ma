              ...
              <div className="service-details-content">
                ...
                <ul className="list-unstyled">
                  <li>
                    ...
                    Sed nisl fusce est consequat mollis habitasse facilisi
                    rutrum nisle.
                  </li>
                  ...
                  <li>
                    ...
                    Cubilia quisque ad accumsan lorem platea elementum nisl
                    curabitur dapibus.
                  </li>
                  <li>
                    <span className="material-symbols-outlined">
                    ...
                    Egestas magnis sapien hack vehicula condimentum dui enim
                    justo site.
                  </li>
                </ul>
