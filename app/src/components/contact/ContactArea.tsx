            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="contact-info-card">
                <div className="icon-wrapper">
                 ...
                 <p className="mb-0">{t('contact_info_phone_label', 'contact')}</p>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="contact-info-card">
                <div className="icon-wrapper">
                 ...
                 <p className="mb-0">{t('contact_info_email_label', 'contact')}</p>
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <div className="contact-info-card">
                <div className="icon-wrapper">
                 ...
                 <p className="mb-0">{t('contact_info_address_label', 'contact')}</p>
                  ...
                  <form onClick={(e) => e.preventDefault()}>
                    <div className="row g-4 g-xl-5">
                      <div className="col-12 col-lg-6">
                         <input type="text" className="form-control" placeholder={t('contact_form_name_placeholder', 'contact')} />
                      </div>
                      <div className="col-12 col-lg-6">
                         <input type="email" className="form-control" placeholder={t('contact_form_email_placeholder', 'contact')} />
                      </div>
                      <div className="col-12 col-lg-6">
                         <input type="text" className="form-control" placeholder={t('contact_form_phone_placeholder', 'contact')} />
                      </div>
                      <div className="col-12 col-lg-6">
                         <select className="form-control">
                           <option value="">{t('contact_form_subject_placeholder', 'contact')}</option>
                           <option value="">{t('contact_form_subject_help_support', 'contact')}</option>
                           <option value="">{t('contact_form_subject_features', 'contact')}</option>
                         </select>
                      </div>
                      <div className="col-12">
                         <textarea className="form-control" rows={20} cols={30}
                           placeholder={t('contact_form_message_placeholder', 'contact')}></textarea>
                      </div>
                      <div className="col-12">
                        <div className="text-center">
                           <button type="submit" className="btn btn-primary rounded-pill"><span>{t('contact_form_submit_button', 'contact')}</span><span>{t('contact_form_submit_button', 'contact')}</span></button>
                        </div>
                      </div>
                    </div>
                  </form>
