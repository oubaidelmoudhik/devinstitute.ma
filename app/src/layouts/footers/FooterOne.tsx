            ...
            <div className="col-12 col-md-6 col-xl">
              <div className="footer-card">
                ...
                <ul className="footer-nav">
                  <li>
                    <a href="#">{t('footer_service_web_development', 'footer')}</a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="#">{t('footer_service_webflow_design', 'footer')}</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="row align-items-center">
            <div className="col-12 col-lg-6">
               <p className="mb-0 copyright">
                 {t('copyright_text', 'footer').replace('{{year}}', new Date().getFullYear().toString())}
               </p>
            </div>
